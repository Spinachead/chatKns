export default {
  ...
  auth: {
    ...
    emailVerificationCodePlaceholder: 'Please enter email verification code',
    refreshCaptcha: 'Refresh Captcha',
    sendEmailCode: 'Send Code',
    noAccount: 'No account? Click to register',
    hasAccount: 'Have account? Click to login',
  ...
  store: {
    ...
    importRepeatContentTips: 'Content is repeatedly skipped: {msg}',
